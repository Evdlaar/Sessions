...
----------------------------
-- THREADPOOL demo
-- Let's take a look at the number of worker threads
...
-- ostress command: "C:\Program Files\Microsoft Corporation\RMLUtils\ostress.exe" -E -dAdventureWorks2012 -i"C:\select_rnd.sql" -n150 -r10 -q
